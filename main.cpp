...
private:
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
    {
        ...
        renderPassInfo.clearValueCount = 1; // Clear value count
    ...
    void createRenderPass()
    {
        ...
        renderPassCreateInfo.dependencyCount = 1;             // 1 dependency
        renderPassCreateInfo.pDependencies = &dependency;     // Reference to dependency
    ...
    void createGraphicsPipeline()
    {
        ...
        pipelineCreateInfo.stageCount = 2;         // 2 shader stages
        pipelineCreateInfo.pStages = shaderStages; // Shader stage info
    ...
    void createSwapChain()
    {
        ...
        VkExtent2D extent = chooseSwapExtent(swapChainSupport.capacities);

        uint32_t imageCount = swapChainSupport.capacities.minImageCount + 1;
        if (swapChainSupport.capacities.maxImageCount > 0 && imageCount > swapChainSupport.capacities.maxImageCount)
        {
            imageCount = swapChainSupport.capacities.maxImageCount;
        }
        ...
        createInfo.preTransform = swapChainSupport.capacities.currentTransform;
    ...
    SwapChainSupportDetails querySwapChainSupport(VkPhysicalDevice device)
    {
        ...
        vkGetPhysicalDeviceSurfaceCapabilitiesKHR(device, surface, &details.capacities);
    ...
    void drawFrame()
    {
        ...
        submitInfo.pWaitSemaphores = waitSemaphores; // Wait for imageAvailableSemaphore
        submitInfo.pWaitDstStageMask = waitStages;   // Wait for color attachment output stage
        submitInfo.commandBufferCount = 1;
        submitInfo.pCommandBuffers = &commandBuffer;

        VkSemaphore signalSemaphores[] = {renderFinishedSemaphore};
        submitInfo.signalSemaphoreCount = 1;             // Signal renderFinishedSemaphore
        submitInfo.pSignalSemaphores = signalSemaphores; // Signal renderFinishedSemaphore
        ...
        presentInfo.pWaitSemaphores = signalSemaphores; // Wait for renderFinishedSemaphore
